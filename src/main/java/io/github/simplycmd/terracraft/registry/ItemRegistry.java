...
import io.github.simplycmd.terracraft.items.accessories.AttackSpeedAccessoryItem;
...
public class ItemRegistry {
    ...
    public static void register() {
        ...
        cloud_in_a_bottle = new SimpleItem(ID("cloud_in_a_bottle"), DoubleJumpAccessoryItem.create(new FabricItemSettings().group(ItemGroup.MISC), ParticleUtils.getParticleId(ParticleTypes.CAMPFIRE_COSY_SMOKE), 50, 0.4, 1)).defaultItemModel();
        ...
        sandstorm_in_a_bottle = new SimpleItem(ID("sandstorm_in_a_bottle"), DoubleJumpAccessoryItem.create(new FabricItemSettings().group(ItemGroup.MISC), ParticleUtils.getParticleId(ParticleTypes.CLOUD), 50, 1.6, 1)).defaultItemModel();
        ...
        tsunami_in_a_bottle = new SimpleItem(ID("tsunami_in_a_bottle"), DoubleJumpAccessoryItem.create(new FabricItemSettings().group(ItemGroup.MISC), ParticleUtils.getParticleId(ParticleTypes.RAIN), 300, 0.8, 1)).defaultItemModel();
