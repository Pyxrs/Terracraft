...
public enum PotBlocks {
    ...
    TUNDRA(3, 1/461.0, BlockReg.get("ice_torch").asItem(), 1.25F),
    JUNGLE(3, 1/400.0, BlockReg.get("jungle_torch").asItem(), 1.75F),
    DUNGEON(3, 1/384.0, Items.TORCH, 1.9F),
    UNDERWORLD(3, 1/365.0, Items.TORCH, 2.1F),
    CORRUPT(3, 1/365.0, BlockReg.get("corrupt_torch").asItem(), 1.6F),
    CRIMSON(3, 1/365.0, BlockReg.get("crimson_torch").asItem(), 1.6F),
    HALLOWED(3, 1/365.0, BlockReg.get("hallowed_torch").asItem(), 1.6F),
    ...
    DESERT(3, 1/461.0, BlockReg.get("desert_torch").asItem(), 1.25F);
